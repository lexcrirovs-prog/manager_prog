...
(function () {
    ...
    const PRIORITY_RU = { low:'Низкий', medium:'Средний', high:'Высокий', critical:'Критический', focus:'Фокус' };
    const STATUS_RU   = {
        pending:'Ожидает', in_progress:'В работе', completed:'Выполнено',
        overdue:'Просрочено', new:'Новая', negotiation:'Переговоры',
        contract:'Контракт', deal:'Сделка', won:'Выиграна', lost:'Проиграна',
        stale:'Заморожена', refusal:'Отказ',
    };
